...
export const VotingRoomCard = ({
  ...
  return (
    <Link
      className="border-pill hover:shadow-pill default-style-none flex items-center gap-2 rounded-xl bg-white p-4 dark:bg-zinc-900"
      onClick={onClick}
    ...
    >
      <div>
        <div className="flex size-10 items-center justify-center rounded-full bg-zinc-900 text-white dark:bg-white dark:text-zinc-900">
          <PiLinkBold size={20} />
        </div>
      </div>
      <div>
